                    ...
                    <div class="item col-md-4 col-sm-6 col-xs-12">
                        <div class="item-inner">
                            <div class="icon-holder">
                                <img class="icon-holder_img" src="/images/poll/frontend.svg" alt="Внешний вид сайта (front-end)">
                            </div><!--//icon-holder-->
                            <p class="intro">Внешний вид сайта (front-end)</p>
                            <a class="link" href="http://oscode.ru/web/frontend.php"><span></span></a>
                        </div><!--//item-inner-->
                    </div><!--//item-->
                    <div class="item col-md-4 col-sm-6 col-xs-12">
                        <div class="item-inner">
                            <div class="icon-holder">
                                <img class="icon-holder_img" src="/images/poll/backend.svg" alt="Работа с сервером (backend)">
                            </div><!--//icon-holder-->
                            <p class="intro">Работа с сервером (backend)</p>
                            <a class="link" href="http://oscode.ru/web/backend.php"><span></span></a>
                        </div><!--//item-inner-->
                    </div><!--//item-->
                </div><!--//cards-->
                    </div><!--//cta-container-->
