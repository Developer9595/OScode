		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form">
					<h4>Ваш адрес электронной почты</h4>
					<p>Укажите вашу электроную почту для востановления пароля</p>
					<div class="wrap-input100 validate-input" data-validate = "Введите правильный Email!">
						<input class="input100" type="text" name="email" placeholder="Почтовый ящик">
