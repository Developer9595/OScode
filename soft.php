...
<head>
    <title>Софт для компьютеров</title>
    <!-- Meta -->
    <meta charset="utf-8">
                    ...
                    <div class="item col-md-4 col-sm-6 col-xs-12">
                        <div class="item-inner">
                            <div class="icon-holder">
                                <img class="icon-holder_img" src="/images/poll/windows.svg" alt="Windows">
                            </div><!--//icon-holder-->
                            <p class="intro">Windows</p>
                            <a class="link" href="http://oscode.ru/soft/windows.php"><span></span></a>
                        </div><!--//item-inner-->
                    </div><!--//item-->
                    <div class="item col-md-4 col-sm-6 col-xs-12">
                        <div class="item-inner">
                            <div class="icon-holder">
                                <img class="icon-holder_img" src="/images/poll/macintosh.svg" alt="Mac">
                            </div><!--//icon-holder-->
                            <p class="intro">Mac</p>
                            <a class="link" href="http://oscode.ru/soft/mac.php"><span></span></a>
                        </div><!--//item-inner-->
                    </div><!--//item-->
                    <div class="item col-md-4 col-sm-6 col-xs-12">
                        <div class="item-inner">
                            <div class="icon-holder">
                                <img class="icon-holder_img" src="/images/poll/linux.svg" alt="Linux">
                            </div><!--//icon-holder-->
                            <p class="intro">Linux</p>
                            <a class="link" href="http://oscode.ru/soft/linux.php"><span></span></a>
                        </div><!--//item-inner-->
                    </div><!--//item-->
                </div><!--//cards-->
                    </div><!--//cta-container-->
