        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
               ...
               <div class="page-block"> 
                    <img src="../../images/asembly.jpg" alt="СИ">
                    <p>В компьютерном программировании , языке ассемблера (или ассемблере ), [1] часто сокращенно ASM , является любым языком программирования низкого уровня , в котором есть очень сильное соответствие между инструкциями языка и архитектурами в машинном коде инструкции . [2] Поскольку сборка зависит от инструкций машинного кода, у каждого ассемблера есть свой собственный язык ассемблера, который разработан специально для одной конкретной компьютерной архитектуры. Язык ассемблера также можно назвать символическим машинным кодом . [3] [4]

Ассемблерный код преобразуется в исполняемый машинный код с помощью служебной программы, называемой ассемблером . Процесс преобразования упоминается как сборка , так как в сборке в исходном коде . Язык ассемблера обычно имеет один оператор на машинную инструкцию (1: 1), но часто также поддерживаются комментарии и операторы, которые являются директивами ассемблера , [5] макросами , [6] [1] и символическими метками расположения программ и памяти .

Термин «ассемблер» , как правило , приписывается Уилкс , Уиллер и Гилл в своей 1951 книги подготовки программ для ЭЦВМ , [7] , который, однако, использовал этот термин для обозначения «программу , которая собирает другую программу , состоящую из нескольких разделы в одну программу ". [8]

Каждый язык ассемблера специфичен для конкретной компьютерной архитектуры, а иногда и для операционной системы . [9] Тем не менее, некоторые языки ассемблера не предоставляют специфический синтаксис для вызовов операционной системы, и большинство языков ассемблера можно универсально использовать с любой операционной системой, поскольку язык обеспечивает доступ ко всем реальным возможностям процессора , при котором все системные вызовы механизмы в конечном итоге покоятся. В отличие от языков ассемблера, большинство языков программирования высокого уровня обычно переносимы на несколько архитектур, но требуют интерпретации или компиляции., гораздо более сложная задача, чем сборка.</p>
                </div>
                <!-- *************************************************************** -->
            </div>
