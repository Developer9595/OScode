        ...
        <div class="page-wrapper">
            ...
            <nav aria-label="Навигация по страницам">
                    <ul class="pagination justify-content-center">
                        <li class="page-item">
                        <a class="page-link" href="cabinet2.php" tabindex="-1">Предыдущая</a>
                        </li>
                        <li class="page-item"><a class="page-link" href="cabinet.php">1</a></li>
                        <li class="page-item">
                        <a class="page-link" href="cabinet2.php">2</a>
                        </li>
                        <li class="page-item active"><a class="page-link" href="cabinet3.php">3</a></li>
                        ...
                        <li class="page-item">
                        <a class="page-link" href="cabinet4.php">Следующая</a>
                        </li>
                    </ul>
                </nav>
            </div>
