...
<body class="landing-page">   
    <div class="page-wrapper">
        ...
        <section class="cards-section text-center">
            <div class="container">
                <div class="intro">
                    <img src="images/404.png" alt="404" width="520px">
                    <p style="padding: 15px; font-size: 18px">Страница не доступно переходит на главную страницу!</p>
                    <a href="index.php" class="btn btn-primary btn-lg" tabindex="-1" role="button" aria-disabled="true">На главную страницу</a>
                </div><!--//intro-->
