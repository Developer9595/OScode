                    ...
                    <div class="item col-md-4 col-sm-6 col-xs-12">
                        <div class="item-inner">
                            <div class="icon-holder">
                                <img class="icon-holder_img" src="/images/poll/apple.svg" alt="Создание игр">
                            </div><!--//icon-holder-->
                            <p class="intro">iOS</p>
                            <a class="link" href="http://oscode.ru/mobile/ios.php"><span></span></a>
                        </div><!--//item-inner-->
                    </div><!--//item-->
                    <div class="item col-md-4 col-sm-6 col-xs-12">
                        <div class="item-inner">
                            <div class="icon-holder">
                                <img class="icon-holder_img" src="/images/poll/android.svg" alt="Мобильные приложения">
                            </div><!--//icon-holder-->
                            <p class="intro">Android</p>
                            <a class="link" href="http://oscode.ru/mobile/android.php"><span></span></a>
                        </div><!--//item-inner-->
                    </div><!--//item-->
                </div>
                </div><!--//cards-->
