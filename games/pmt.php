...
<head>
    <title>Под мобильные телефоны</title>
    <!-- Meta -->
    <meta charset="utf-8">
                    ...
                    <div class="item col-md-4 col-sm-6 col-xs-12">
                        <div class="item-inner">
                            <div class="icon-holder">
                                <img class="icon-holder_img" src="../../images/poll/simple-game.svg" alt="2D игры">
                            </div><!--//icon-holder-->
                            <p class="intro">2D игры</p>
                            <a class="link" href="http://oscode.ru/games/2d.php"><span></span></a>
                        </div><!--//item-inner-->
                    </div><!--//item-->
                    <div class="item col-md-4 col-sm-6 col-xs-12">
                        <div class="item-inner">
                            <div class="icon-holder">
                                <img class="icon-holder_img" src="../../images/poll/games.svg" alt="3D игры">
                            </div><!--//icon-holder-->
                            <p class="intro">3D игры</p>
                            <a class="link" href="http://oscode.ru/games/3d.php"><span></span></a>
                        </div><!--//item-inner-->
                    </div><!--//item-->
                </div><!--//cards-->
                    </div><!--//cta-container-->
