...
<head>
    <title>Компьютеры и игровые консоли</title>
    <!-- Meta -->
    <meta charset="utf-8">
                    ...
                    <div class="item col-md-4 col-sm-6 col-xs-12">
                        <div class="item-inner">
                            <div class="icon-holder">
                                <img class="icon-holder_img" src="../../images/poll/simple-game.svg" alt="Небольшие игры">
                            </div><!--//icon-holder-->
                            <p class="intro">Небольшие игры</p>
                            <a class="link" href="http://oscode.ru/games/ni.php"><span></span></a>
                        </div><!--//item-inner-->
                    </div><!--//item-->
                    <div class="item col-md-4 col-sm-6 col-xs-12">
                        <div class="item-inner">
                            <div class="icon-holder">
                                <img class="icon-holder_img" src="../../images/poll/games.svg" alt="Крупные проекты">
                            </div><!--//icon-holder-->
                            <p class="intro">Крупные проекты</p>
                            <a class="link" href="http://oscode.ru/games/kp.php"><span></span></a>
                        </div><!--//item-inner-->
                    </div><!--//item-->
                </div><!--//cards-->
                    </div><!--//cta-container-->
